...
#
# Example usage:
#   python src/data_prep.py --n 1000
#   python src/data_prep.py --n 2000 --min_tokens 10 --max_tokens 25
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Prepare filtered SST-2 sentences for the entropy experiment."
    )
